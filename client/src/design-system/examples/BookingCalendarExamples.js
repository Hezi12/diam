...
import { STYLE_CONSTANTS, getHebrewInputStyle, getBookingStatusColors } from '../styles/StyleConstants';

/**
 * BookingCalendarExamples
 * דוגמה ליישום יומן הזמנות מלא
 * 
 * קובץ זה מהווה דוגמה ליישום של רכיב מורכב תוך שימוש בהנחיות העיצוב
 * ומציג כיצד לממש אינטראקציות ותצוגת יומן בסגנון העיצוב האחיד
 */
