...
/**
 * DesignExamples
 * דוגמאות לרכיבי עיצוב בסיסיים
 * 
 * קובץ זה משמש כמקור ייחוס לעיצוב האחיד של רכיבי המערכת
 * בעת יצירת קומפוננטים חדשים יש להיעזר בדוגמאות אלה כדי לשמור על אחידות
 */
