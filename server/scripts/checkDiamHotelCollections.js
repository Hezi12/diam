...
async function checkCollections() {
  try {
    ...
    const conn = await mongoose.connect('mongodb+srv://Hezi:Hezi!3225@cluster0.o8qdhf0.mongodb.net/diam_hotel?retryWrites=true&w=majority&appName=Cluster0');
    ...
    console.log('\nאוספים במסד הנתונים diam_hotel:');
    console.log('-----------------------------');
